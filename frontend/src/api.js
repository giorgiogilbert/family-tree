...
// Sharing
export const shareMember = (treeId, email, role) =>
  request("POST", `/trees/${treeId}/share`, { email, role });
export const updateMember = (treeId, uid, role) =>
  request("PATCH", `/trees/${treeId}/share/${uid}`, { role });
export const removeMember = (treeId, uid) =>
  request("DELETE", `/trees/${treeId}/share/${uid}`);
